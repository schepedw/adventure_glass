...
set :application, 'Adventure Glass'
set :repository,  'https://github.com/schepedw/adventure_glass.git'
set :deploy_to, '/export/web/adventure_glass'
server '45.79.137.90', :app, :web, :db, primary: true
...
BP = 'bundle exec bluepill --no-privileged'.freeze
